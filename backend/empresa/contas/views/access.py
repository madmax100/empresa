...
class AtivosPatrimonioViewSet(viewsets.ModelViewSet):
    queryset = AtivosPatrimonio.objects.all()
    serializer_class = AtivosPatrimonioSerializer

class ManutencoesAtivosViewSet(viewsets.ModelViewSet):
    queryset = ManutencoesAtivos.objects.all()
    serializer_class = ManutencoesAtivosSerializer
