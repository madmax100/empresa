                    ...
                    <td style={{
                      ...
                      <button
                        ...
                        onMouseEnter={(e) => {
                          ...
                          button.style.backgroundColor = clienteExpandido === cliente.id ? '#dc2626' : '#2563eb';
                        }}
                        onMouseLeave={(e) => {
                          const button = e.target as HTMLButtonElement;
                          button.style.backgroundColor = clienteExpandido === cliente.id ? '#ef4444' : '#3b82f6';
                        }}
                      >
                        {clienteExpandido === cliente.id ? 'Fechar' : 'Ver Produtos'}
                      </button>
                    </td>
                  </tr>
                      ...
                      <td colSpan={5} style={{
                        ...
                        <div style={{
                          ...
                          <h3 style={{
                            ...
                            🛍️ Produtos Fornecidos - {cliente.nome}
                          </h3>
                          ...
                          <div style={{
                            ...
                            {(() => {
                              const todosItens = cliente.contratos.flatMap(contrato => {
                              ...
                              // Se não há itens, mostrar mensagem informativa
                                ...
                                return (
                                  <div style={{
                                    ...
                                    <p style={{ 
                                      ...
                                      Os detalhes dos produtos fornecidos para este cliente não puderam ser carregados no momento.
                                    </p>
                                  </div>
                                );
                              }
