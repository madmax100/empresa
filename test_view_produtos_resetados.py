#!/usr/bin/env python
"""
Script para testar a view ProdutosResetadosViewSet.
"""
...
from empresa.contas.views.produtos_resetados_view import ProdutosResetadosViewSet

def test_produtos_resetados_view():
